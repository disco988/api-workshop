  ...
  return (
    <div className="space-y-3">
      ...
      {hasBody && (
        <div className="space-y-1.5">
          <div className="flex items-center justify-between">
            ...
            {showBodyHint && (
              <span className="text-xs text-slate-600">string = cudzysłowy, number = bez</span>
            )}
          </div>
          <textarea
            value={body}
      ...
      <div className="rounded-lg border border-slate-700 bg-slate-900 p-4 min-h-[80px]">
        <p className="text-xs font-medium text-slate-600 uppercase tracking-wide mb-3">Odpowiedź serwera</p>
